   ...
   return (
      <Dialog.Root>
         ...
         <Dialog.Portal>
            ...
            <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[400px] p-6 bg-slate-600 rounded-xl flex flex-col items-center">
